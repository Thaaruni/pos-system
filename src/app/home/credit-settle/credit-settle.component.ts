    ...
    <div class="bg-gradient-to-r from-yellow-100 to-yellow-300 border-2 border-yellow-600 p-4 rounded shadow-md text-sm w-full max-w-6xl mx-auto">
      ...
      <div class="border-b border-yellow-700 pb-2">
        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
          <div>
            ...
            <input type="text" class="w-full bg-white border border-gray-400 p-1" value="STORE" />
          </div>
          <div>
          ...
          <div>
            <label class="block font-semibold">Ref. No:</label>
          ...
          <div>
            <label class="block font-semibold">Cus Code</label>
            <input type="text" class="w-full bg-white border border-gray-400 p-1" />
          </div>
        </div>
        ...
        <div class="grid grid-cols-4 gap-4 mb-2">
          ...
          <div>
            <label class="block font-semibold">Staff</label>
            <select class="w-full bg-white border border-gray-400 p-1">
              <option>NON</option>
            </select>
          </div>
        ...
        <button class="bg-gray-200 text-sm font-bold px-3 py-1 mt-1 border border-gray-500 rounded cursor-pointer hover:bg-gray-400 hover:text-white transition duration-200 ">History</button>
      ...
      <div class="border-b border-yellow-700 pb-2">
        ...
        <div class="mt-6 overflow-x-auto">
          <table class="w-full text-xs border border-collapse border-gray-700">
            ...
            <tr>
              ...
              <th class="border border-gray-700 p-1">Ref. No</th>
              <th class="border border-gray-700 p-1">Inv. Date</th>
              <th class="border border-gray-700 p-1">Inv. Time</th>
              <th class="border border-gray-700 p-1">No of Days</th>
              <th class="border border-gray-700 p-1">Invoice Amt.</th>
              <th class="border border-gray-700 p-1">Due Amount</th>
              <th class="border border-gray-700 p-1">Wipe Amt.</th>
        ...
        <div class="flex justify-between mt-4 text-sm">
          <div>
            <button class="bg-gray-200 px-3 py-1 font-bold border border-gray-500 mr-2 rounded cursor-pointer hover:bg-gray-400 hover:text-white transition duration-200">Clear Selected</button>
      ...
      <div class="mt-6">
        ...
        <div class="flex justify-end items-end mt-4 space-x-8 ">
          <div class="space-x-2">
            <button class="bg-gray-200 px-3 py-1 font-bold border border-gray-500 rounded cursor-pointer hover:bg-gray-400 hover:text-white transition duration-200">Clear All</button>
            <button class="bg-blue-500  px-3 py-1 font-bold rounded cursor-pointer hover:bg-blue-700 hover:text-white transition duration-200">Save</button>
            <button class="bg-red-500 font-bold px-3 py-1 rounded cursor-pointer hover:bg-red-700 hover:text-white transition duration-200">Exit</button>
          </div>
